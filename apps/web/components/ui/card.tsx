...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-sm font-medium text-foreground group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
